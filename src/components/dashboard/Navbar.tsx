...
function Navbar({
	...
	return (
		<header className="sticky top-0 z-10 flex w-full bg-slate-800 dark:drop-shadow-none">
			<div className="flex items-center justify-between flex-grow px-4 py-4 shadow md:px-6 2xl:px-11">
				<div className="flex items-center gap-2 sm:gap-4 lg:hidden">
					<button
						className="z-10 block rounded-sm border border-slate-400 p-1.5 shadow-sm lg:hidden"
					...
					<Link to="#" className="flex-shrink block lg:hidden">
						<img
				...
				<div className="hidden sm:block">
					<form>
						<div className="flex gap-3 p-3 rounded-md text-slate-400 focus-within:ring-2 ring-slate-600">
							...
							<input
								...
								className="text-sm bg-transparent font-poppins focus:outline-0"
							/>
						</div>
					</form>
				</div>
				...
				<div className="flex items-center gap-4">
					<ul className="inline-flex items-center gap-3">
						...
						<li>
							<button className="p-1.5 transition-colors rounded-full text-slate-400 bg-zinc-300/20 hover:text-white">
								<BellIcon
									color="currentColor"
									size={20}
									strokeWidth={1.5}
					...
					<div className="relative">
						<button
							className="inline-flex items-center gap-3 font-poppins"
						...
						>
							<span className="hidden text-right lg:block">
								...
								<span className="block text-xs font-medium dark:text-slate-400">
									Web Developer
								</span>
							</span>
							...
							<svg
								className="hidden fill-slate-400 sm:block"
								width="12"
								height="8"
								viewBox="0 0 12 8"
								fill="none"
						...
						<div
							className={`absolute right-0 flex-col mt-4 border rounded-md shadow text-slate-300 w-60 bg-slate-800 font-poppins ${
								isSubmenuOpen ? "block" : "hidden"
							}`}
						>
							<ul className="flex flex-col gap-5 px-6 border-b border-stroke py-7">
								<li>
									<Link
										to="/profile"
